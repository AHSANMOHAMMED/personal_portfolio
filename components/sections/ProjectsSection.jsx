...
export default function ProjectsSection() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < n - 1; i++) {
      ...
      if (next) {
        ...
        const actions = next.querySelector(`.${styles.actions}`)
        ...
        if (actions) tl.fromTo(actions, { y: 8, opacity: 0 }, { y: 0, opacity: 1, duration: 0.30, ease: 'power2.out' }, i + 0.72)
      }
    }
  ...
  return (
    <div style={{ height: `${PROJECTS.length * 100}vh` }}>
      <section ref={sectionRef} className={styles.section} aria-label="Featured Projects">
