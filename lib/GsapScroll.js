...
export function setCharTimeline(character, camera) {
  // Reset any previous scrub transform so the hero character is visible
  gsap.set('.character-model', { x: 0, y: 0, clearProps: 'transform' })
  // Re-apply CSS centering after clearing GSAP transforms
